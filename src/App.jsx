...
function App() {
  ...
  useGSAP(()=>{
    ...
    main?.addEventListener("mousemove", moveBackground);
    main?.addEventListener("touchmove", moveBackground);

    return () => {
      main?.removeEventListener("mousemove", moveBackground);
      main?.removeEventListener("touchmove", moveBackground);
    };
        ...
        {showContent && (
          <div className='main w-full rotate-[-10deg] scale-[1.5]'>
            ...
            <div className='w-full min-h-screen gap-0 px-10 flex items-center justify-center bg-black'>
              <div className='cntnr relative flex flex-col lg:flex-row text-white w-full h-[80%] pb-32 md:pb-40'>
                <div className='limg w-full lg:w-1/2 h-full'>
                </div>
                <div className='rg flex flex-col lg:flex-row lg:gap-12 lg:items-center'>
                  <h1 className='leonida text-6xl lg:text-8xl w-full lg:w-[40%] translate-x-0 lg:-translate-x-1/3 mb-6 lg:mb-0'>Only in Leonida</h1>
                  <p className='prgtag text-xl lg:text-3xl w-full lg:w-[28%] translate-y-0 lg:translate-y-1'>When the sun fades and the neon glows, everyone has something to gain — and more to lose.</p>
                </div>
              </div>
            </div>
            <div className='btm flex flex-col lg:flex-row bg-black pb-32 md:pb-40'>
              ...
              <div className='text-white relative w-full lg:w-1/2 mt-10 lg:mt-[15%] flex flex-col px-6 lg:px-0'>
                <h1 className='text-4xl md:text-6xl lg:text-6xl text-[#FFB0C4] font-[600] font-[sans-serif]'>Lucia Caminos</h1>
                <p className='font-[helvetica] text-lg md:text-3xl mt-6 md:mt-10 w-full lg:w-[70%]'>Life has been coming at her swinging ever since. Fighting for her family landed her in the Leonida Penitentiary. Sheer luck got her out. Lucia’s learned her lesson — only smart moves from here.</p>
              </div>
            </div>
            ...
            <div className='fixed bottom-0 flex text-white right-2 gap-1 px-3 md:px-6'>
              <p className='font-[montserrat]'>Made with</p>
              <i className="ri-heart-3-fill text-red-500"></i>
              <p className='font-[montserrat]'>by</p>
              <a className='font-[Helvetica-Neue]' href="https://www.linkedin.com/in/kunal-kashyap-601094170/" target='_blank' rel="noopener noreferrer">Kunal Kashyap</a>
            </div>
          </div>
        )}
    </>
