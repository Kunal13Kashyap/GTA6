      ...
      {showContent && (
        <div className='main w-full rotate-[-10deg] scale-[1.5]'>
          ...
          <div className='w-full min-h-screen gap-0 px-10 flex items-center justify-center bg-black'>
            <div className='cntnr relative flex text-white w-full h-[80%]'>
              <div className='limg w-1/2 h-full'>
              </div>
              <div className='rg flex'>
                <h1 className='leonida text-8xl w-[40%] -translate-x-1/3'>Only in Leonida</h1>
                <p className='prgtag text-3xl w-[28%] translate-y-1'>When the sun fades and the neon glows, everyone has something to gain — and more to lose.</p>
              </div>
            </div>
          </div>
          <div className='btm flex flex-row bg-black'>
            <div className='relative aspect-[3/4] w-1/2'>
              <img className='h-full w-full object-cover' src="./imag.png" alt="" />
            </div>
            <div className='text-white relative w-1/2 mt-[15%] flex flex-col'>
              <h1 className='text-6xl mt-10 text-[#FFB0C4] font-[600] font-[sans-serif]'>Lucia Caminos</h1>
              <p className='font-[helvetica] text-3xl mt-10 w-[50%]'>Life has been coming at her swinging ever since. Fighting for her family landed her in the Leonida Penitentiary. Sheer luck got her out. Lucia’s learned her lesson — only smart moves from here.</p>
            </div>
            <button className='fixed bottom-10 right-3/8 uppercase bg-yellow-500 px-10 py-6 text-4xl text-black font-[impact]'>Download Now</button>
